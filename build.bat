...
title AgrupadorPDF - Build v1.5.0

echo.
echo =====================================================
echo    AgrupadorPDF v1.5.0  -  Build Script
echo =====================================================
echo.
...
echo OK - PyInstaller + pypdf + Pillow + tkinterdnd2 + scikit-learn + rapidfuzz + networkx
echo.
...
echo =====================================================
echo.
echo Instalador: dist_installer\AgrupadorPDF_v1.5.0_Installer.exe
echo.
